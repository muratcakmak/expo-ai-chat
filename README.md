...
Expo test app (prebuild/CNG) for developing and testing the module.
...
```
expo-ai-chat/
├── app/                    # Expo test app (SDK 57, RN 0.86)
│   ├── App.tsx             # Test chat screen
│   └── (ios/, android/)    # Native projects — generated by prebuild, not committed
